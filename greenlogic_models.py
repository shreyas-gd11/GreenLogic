...
class GreenLogicAction:
    ...
    @classmethod
    def from_value(cls, value: str | "GreenLogicAction") -> "GreenLogicAction":
        if isinstance(value, GreenLogicAction):
            return value
        return cls(action=value)


@dataclass
class GreenLogicObservation:
    day: int
    soilMoisture: float
    temperature: float
    cropHealth: float
...
@dataclass
class StepResult:
    observation: GreenLogicObservation
    reward: float
    done: bool
    info: dict[str, Any]
